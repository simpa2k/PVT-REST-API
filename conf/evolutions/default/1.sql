...
alter table string_descriptor drop constraint if exists fk_string_descriptor_address_description_id;
drop index if exists ix_string_descriptor_address_description_id;
